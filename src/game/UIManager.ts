...
export type GameStateType = GameState[keyof GameState];
...
export class UIManager {
  ...
  private readonly onStopGame: () => void;
  ...
  private handleCanvasTouch(x: number, y: number): void {
    switch (this.currentState) {
      case "menu":
